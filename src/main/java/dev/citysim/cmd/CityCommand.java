...
import dev.citysim.cmd.subcommand.ScanCityCommand;
...
public class CityCommand implements CommandExecutor {
    ...
    public CityCommand(CitySimPlugin plugin,
        ...
        register(new RemoveCityCommand(cityManager, visualizationService));
        ...
        register(new BudgetCommand(cityManager, budgetService));
